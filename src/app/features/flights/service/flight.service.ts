...
export class FlightService {
  ...
  private staticFlights: Omit<Flight, 'boardingDate' | 'arrivalDate'>[] = [
    ...
    { flightNumber: 'LX8396', origin: 'Zurich', destination: 'Moscow', numberOfSeats: 150, imageUrl: "https://www.elal.com/magazine/wp-content/uploads/2017/01/shutterstock_166350926.jpg"},
